...
import type { AgentDeployment, HealthStatus } from '../../compute/control-plane/agent/agentDescriptor';
...
export async function runHealthCheck(): Promise<HealthCheckResult[]> {
  ...
  const { getAgentDeploymentService } = await import('../../compute/control-plane/agent/agentDeploymentService');
  const { getDeployer } = await import('../../compute/providers');
