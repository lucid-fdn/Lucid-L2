...
Model Context Protocol (MCP) Server for the *raijin-labs* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=raijin-labs&utm_campaign=mcp-typescript)
[![License: MIT](https://img.shields.io/badge/LICENSE_//_MIT-3b5bdb?style=for-the-badge&labelColor=eff6ff)](https://opensource.org/licenses/MIT)


<br /><br />
> [!IMPORTANT]
> This MCP Server is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/raijin-labs/lucid). Delete this notice before publishing to a package manager.
...
[![Install MCP Server](https://cursor.com/deeplink/mcp-install-dark.svg)](cursor://anysphere.cursor-deeplink/mcp/install?name=RaijinLabs&config=eyJtY3BTZXJ2ZXJzIjp7IlJhaWppbkxhYnMiOnsiY29tbWFuZCI6Im5weCIsImFyZ3MiOlsicmFpamluLWxhYnMiLCJzdGFydCJdfX19)
...
```bash
claude mcp add raijin-labs npx raijin-labs start --
```
...
```bash
npx raijin-labs start
```

For a full list of server arguments, run:

```
npx raijin-labs --help
```
...
### MCP Server Created by [Speakeasy](https://www.speakeasy.com/?utm_source=raijin-labs&utm_campaign=mcp-typescript)
