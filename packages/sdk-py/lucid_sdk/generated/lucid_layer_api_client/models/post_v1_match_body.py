...
if TYPE_CHECKING:
  ...
  from ..models.post_v1_match_body_compute_catalog_item import PostV1MatchBodyComputeCatalogItem
  from ..models.post_v1_match_body_model_meta import PostV1MatchBodyModelMeta





T = TypeVar("T", bound="PostV1MatchBody")



@_attrs_define
class PostV1MatchBody:
    """ 
        Attributes:
            model_meta (PostV1MatchBodyModelMeta | Unset):
            policy (Policy | Unset):
            compute_catalog (list[PostV1MatchBodyComputeCatalogItem] | Unset):
            require_live_healthy (bool | Unset):  Default: True.
     """

    model_meta: PostV1MatchBodyModelMeta | Unset = UNSET
    policy: Policy | Unset = UNSET
    compute_catalog: list[PostV1MatchBodyComputeCatalogItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_model_meta,  Unset):
            ...
            model_meta = PostV1MatchBodyModelMeta.from_dict(_model_meta)
        ...
        if _compute_catalog is not UNSET:
            ...
            for compute_catalog_item_data in _compute_catalog:
                compute_catalog_item = PostV1MatchBodyComputeCatalogItem.from_dict(compute_catalog_item_data)
        ...
        post_v1_match_body.additional_properties = d
        return post_v1_match_body
