...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetAgentRootRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/agents/{agentId}/root")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAgentRootResponse$inboundSchema),
