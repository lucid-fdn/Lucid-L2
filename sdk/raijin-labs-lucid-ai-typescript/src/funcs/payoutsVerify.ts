...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.LucidVerifyPayoutRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/payouts/{run_id}/verify")(pathParams);
