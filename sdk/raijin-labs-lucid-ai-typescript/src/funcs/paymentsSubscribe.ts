 ...
 */
export function paymentsSubscribe(
  client: LucidSDKCore,
  request: operations.SubscribeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SubscribeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SubscribeRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/access/subscribe")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SubscribeResponse$inboundSchema),
