...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.LucidRetryEpochRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/epochs/{epoch_id}/retry")(pathParams);
