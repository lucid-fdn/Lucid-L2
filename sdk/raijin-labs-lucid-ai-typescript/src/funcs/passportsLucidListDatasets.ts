...
export function passportsLucidListDatasets(
  ...
  Result<
    operations.LucidListDatasetsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.LucidListDatasetsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidListDatasetsResponse$inboundSchema),
