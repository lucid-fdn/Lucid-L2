...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.LucidGetDisputeRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/disputes/{chainId}/{disputeId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetDisputeResponse$inboundSchema),
