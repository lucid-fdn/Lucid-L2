 ...
 */
export function agentsValidateFlowspec(
  client: LucidSDKCore,
  request: { [k: string]: any },
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ValidateFlowspecResponse,
...
> {
  ...
  const path = pathToFunc("/api/agents/validate")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ValidateFlowspecResponse$inboundSchema),
