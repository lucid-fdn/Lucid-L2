 ...
 */
export function matchPlanRoute(
  client: LucidSDKCore,
  request: operations.LucidRouteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidRouteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.LucidRouteRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidRouteResponse$inboundSchema),
