 ...
 */
export function passportsLucidListAgentPassports(
  client: LucidSDKCore,
  request?: operations.LucidListAgentPassportsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.LucidListAgentPassportsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.LucidListAgentPassportsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidListAgentPassportsResponse$inboundSchema),
