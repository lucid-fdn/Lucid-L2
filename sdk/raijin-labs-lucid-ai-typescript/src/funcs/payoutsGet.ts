...
export function payoutsGet(
  ...
  Result<
    operations.LucidGetPayoutResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.LucidGetPayoutRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/payouts/{run_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.LucidGetPayoutResponse$inboundSchema),
